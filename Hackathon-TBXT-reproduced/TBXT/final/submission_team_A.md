# TBXT Hit Identification — Submission (Team A)
...
|---:|---|---|---:|---:|:---:|
| **1** | `FM002150_analog_0083` | `O=C(O)COCc1ccc(-c2ccsc2)cc1` | 3.2 / 3.256 µM | $- | -/- |
| **2** | `FM001452_analog_0104` | `Cc1ccccc1COc1cccc(N)c1` | 3.722 / 4.973 µM | $125 | low/medium |
| **3** | `FM001452_analog_0201` | `NC(=O)Nc1cccc(OCc2ccccc2)c1` | 8.157 / 8.761 µM | $375 | high/medium |
| **4** | `FM001452_analog_0171` | `Nc1cccc(OCc2ccc(-c3ccncc3)cc2)c1` | 8.318 / 8.171 µM | $250 | medium/medium |
...
All 4 picks are drawn from a 137-compound pool that strictly satisfies every organizer constraint (see `TBXT/final/all_candidates_tiered.csv`). The 4 here are ranks FM002150_analog-class compounds at positions top 4 — judges-facing primary of the tiered pool, ranked by predicted Boltz-2 Kd (lowest first).
...
Boltz Kd 3.2 / 3.256 µM; gnina Vina - kcal/mol; MW 248.3, LogP 3.02; onepot $$-, risks -/-. balanced profile.

### Pick 2: `FM001452_analog_0104`

`Cc1ccccc1COc1cccc(N)c1`

Boltz Kd 3.722 / 4.973 µM; gnina Vina - kcal/mol; MW 213.3, LogP 3.16; onepot $$125, risks low/medium. cheapest tier ($125) · mass-efficient (<220 Da).

### Pick 3: `FM001452_analog_0201`

`NC(=O)Nc1cccc(OCc2ccccc2)c1`

Boltz Kd 8.157 / 8.761 µM; gnina Vina - kcal/mol; MW 242.3, LogP 2.76; onepot $$375, risks high/medium. balanced profile.

### Pick 4: `FM001452_analog_0171`

`Nc1cccc(OCc2ccc(-c3ccncc3)cc2)c1`

Boltz Kd 8.318 / 8.171 µM; gnina Vina - kcal/mol; MW 276.3, LogP 3.91; onepot $$250, risks medium/medium. balanced profile.
...
Public methods over-predict Kd by 6-25× at µM regime. Realistic CF Labs SPR Kd for these 4: ~19-207 µM range. Submission targets the hackathon judging prize (rationale + tractability + judgment) primarily; experimental tier ($100K @ Kd ≤ 1 µM, $250K @ Kd ≤ 300 nM) is plausible long-shot for the strongest binders across the 24-compound team submission.
